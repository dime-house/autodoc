    ...
    theme      : {
        ...
        extend  : {
            ...
            typography: ({theme}) => ({
                DEFAULT: {
                    css: {
                        color              : 'var(--dime-text-default)',
                        '[class~="lead"]'  : {
                            color: 'var(--dime-text-secondary)'
                        },
                        a                  : {
                            color: 'var(--dime-primary-500)'
                        },
                        strong             : {
                            color: 'var(--dime-text-default)'
                        },
                        ...
                        'ul > li::before'  : {
                            backgroundColor: 'var(--dime-text-hint)'
                        },
                        hr                 : {
                        ...
                        blockquote         : {
                            color          : 'var(--dime-text-default)',
                            borderLeftColor: 'var(--dime-border)'
                        },
                        h1                 : {
                            color: 'var(--dime-text-default)'
                        },
                        ...
                        thead              : {
                            color            : 'var(--dime-text-default)',
                            borderBottomColor: 'var(--dime-border)'
                        },
                        'tbody tr'         : {
                            borderBottomColor: 'var(--dime-border)'
                        },
